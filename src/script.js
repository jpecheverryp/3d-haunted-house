...
walls.position.y = 2.5 / 2 // Half the house height
house.add(walls)
...
roof.position.y = 2.5 + .5 // Height of house + half of itself
...
door.position.y = 2 * 0.5 // Half the door height
door.position.z = (4 * 0.5) + 0.01 // Half the house plus one centimeter to avoid z fighting
house.add(door)
